<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="homework3.Search" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Search Redline Apparel</title>
...
<body>
    ...
    <div class="body">
        ...
        <div class="items">
            <h1 id="searchResult" style="font-size: 18px"><span id="resultsTotal">0</span> results found for "<span id="searchedItem"> </span>"</h1>
        </div>
    </div>
    <div class="footer">
